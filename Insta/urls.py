...
from Insta.views import (HelloDjango, PostListView, PostDetailView, 
                         ...
                         UserDetailView, EditProfileView, ExploreView)
...
urlpatterns = [
    ...
    path('user/edit_profile/<int:pk>/', EditProfileView.as_view(), name = 'edit_profile'),
    path('post/explore', ExploreView.as_view(), name = 'explore'),
]